                ...
                <div class="product-details-info">
                    ...
                    <div class="detail-section">
                        ...
                        <div class="quantity-selector">
                            ...
                            <input type="number" id="detailQty" class="qty-input" value="1" min="1" max="${product.stock}" oninput="window.handleDetailQtyInput(this)" onblur="window.handleDetailQtyBlur(this)">
                            <button class="qty-btn" onclick="window.adjustDetailQty(1)">+</button>
                        </div>
                    </div>
