...
Environmental scanning is conducted to identify the external and internal factors that may influence the success of Lumina Electronics' operations and the development of its online platform. This involves recognizing the opportunities that can be maximized and the challenges that may pose risks.

### Opportunities

One of the key opportunities for the company is the **growing electronics and maker culture in the Philippines**, with more Filipinos exploring DIY projects, robotics, IoT (Internet of Things), and 3D printing. The rise of STEM education programs in schools and universities has also created a steady demand for electronic components among students and educators. Lumina Electronics benefits from its commitment to sourcing **authentic, quality-tested components** from verified global manufacturers, ensuring reliability that generic marketplaces cannot guarantee.

Additionally, the **rise of e-commerce and technology platforms** opens wider market access, allowing the business to connect with engineering students, hobbyists, robotics clubs, professional engineers, and even home makers. Services such as **same-day delivery for Metro Manila** and **expert technical support** from in-house engineers further enhance customer satisfaction and competitiveness. The growing **3D printing community** and **IoT enthusiast market** (especially ESP32-based projects) present significant growth opportunities.

### Threats

On the other hand, the company also faces several threats. The **increasing presence of competitors**, including international e-commerce platforms (AliExpress, Lazada, Shopee) and established local electronics suppliers, creates a highly competitive environment. These platforms often offer lower prices due to bulk importing, making price competition challenging.

**Rising operational costs**, such as import fees, shipping expenses, and warehouse rental, may also impact product pricing. Furthermore, challenges like **traffic congestion in Metro Manila** can affect the timeliness of deliveries, while **customer loyalty towards existing suppliers** (particularly long-established electronics stores in Raon, Manila) may slow down market penetration. The prevalence of **counterfeit or low-quality components** in the market also poses a challenge, as customers may initially be drawn to cheaper alternatives before experiencing quality issues.

### Location Analysis

In terms of location, **Makati City, Metro Manila** provides both advantages and disadvantages. Its strategic proximity to major business hubs such as Bonifacio Global City, Ortigas, and Quezon City allows for efficient access to a large number of universities, tech companies, and maker spaces. The concentration of engineering schools and tech startups in the area creates a dense target market for electronic components.

However, the **high cost of operating in Metro Manila** and logistical issues like **heavy traffic** remain significant concerns. Delivery delays during peak hours can affect customer satisfaction, and rental costs for warehouse and retail space are considerably higher than in provincial areas.

### Summary

Overall, the environmental scan highlights that while Lumina Electronics has strong opportunities for growth through its quality products, technical expertise, and strategic location, it must also address competition from international platforms, rising operational costs, and delivery challenges to maximize its potential. The company's focus on authenticity, customer support, and community building (through tutorials and learning resources) serves as key differentiators in a crowded marketplace.

---

## Goals and Objectives

The primary goal of Lumina Electronics in developing a company website is to strengthen its digital presence and adapt to the growing reliance on online platforms for business transactions. While the company has established itself as a reliable supplier of electronic components since 2020, building a dedicated e-commerce website allows it to extend its reach, improve customer engagement, and provide better service accessibility to Filipino innovators nationwide.

Specifically, the objectives of the website are as follows:

1. **Increase Brand Visibility** – Establish an online platform that enhances awareness of Lumina Electronics and showcases its wide range of electronic components and services to a broader market, including students, hobbyists, and professional engineers.

2. **Boost Sales and Market Reach** – Provide an accessible channel for customers, including engineering students, robotics clubs, DIY enthusiasts, and professional engineers, to purchase products and access services conveniently from anywhere in the Philippines.

3. **Streamline Customer Service** – Offer clear information on products, specifications, pricing, stock availability, and delivery options to improve customer satisfaction and reduce inquiry handling time.

4. **Support Business Growth** – Enable the company to stay competitive against international e-commerce platforms and local suppliers by adapting to digital commerce trends and offering unique value propositions.

5. **Strengthen Client Relationships** – Provide updates, promotional deals, coupons, and direct communication channels to build stronger connections with loyal and potential customers.

6. **Promote Learning and Community Building** – Highlight Lumina Electronics' commitment to education through tutorials, learning resources, and support for schools, robotics clubs, and maker communities.

7. **Enable IoT Device Integration** – Offer a unique value-added service allowing customers to register and remotely control ESP32-based devices purchased from the store, enhancing the overall customer experience.

Through the website, Lumina Electronics not only aims to modernize its operations but also to ensure that it remains a trusted and accessible partner for electronics enthusiasts, students, and professionals in Metro Manila and beyond.
