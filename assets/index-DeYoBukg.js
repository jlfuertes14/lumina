    ...
    `,$=()=>{const g=[...e.orders].sort((h,y)=>new Date(y.createdAt)-new Date(h.createdAt));return`
        ...
        <div class="admin-table-container">
            <table class="admin-table">
                ...
                <tbody>
                    ${g.length>0?g.map(h=>{const y=e.users.find(E=>E.id===h.userId),M=y?y.name:"Unknown",T=y?.address||{},_=h.shippingAddress||(T.street?`${T.street}, ${T.barangay||""}, ${T.city||""}, ${T.province||""} ${T.postalCode||""}`:"No address provided");return`
                        <tr>
                ...
                <div class="product-details-info">
                    ...
                    <div class="detail-section">
                        ...
                        <div class="quantity-selector">
                            ...
                            <input type="number" id="detailQty" class="qty-input" value="1" min="1" max="${o.stock}" oninput="window.handleDetailQtyInput(this)">
                            <button class="qty-btn" onclick="window.adjustDetailQty(1)">+</button>
                        </div>
                    </div>
